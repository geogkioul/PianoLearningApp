# 🎹 PlayWise: AI-Powered Piano Transcription & Difficulty Estimation
...
- **Πολύ αργή μεταγραφή:**
	Το PyTorch ελέγχει αυτόματα αν υπάρχει εγκατεστημένη τεχνολογία CUDA. Αν τρέχετε τον κώδικα με απλό επεξεργαστή (CPU), η επεξεργασία του νευρωνικού δικτύου διαρκεί αρκετά λεπτά. Η χρήση κάρτας γραφικών NVIDIA (GPU) μειώνει τον χρόνο σε λίγα δευτερόλεπτα.